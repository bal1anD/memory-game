...
There were some issues with JSfiddle so I am hosting the project here.
...
2) You will see a grid of size 4x4 squares with pink bows (corresponds to &#x1f380). One square represents 1 card.
3) To play the game click on a square, it will flip and display an icon, then click on another card.
...
4) Once you successfully finish the game, all the cards would face-up with their icons and their background will be green. 
...
5) If you want to play the game again, then click on "Try Again" and it will reshuffle the cards and set-up a 
   fresh board.
